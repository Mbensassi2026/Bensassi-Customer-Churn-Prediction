...
client = openai.OpenAI(
    ...
    api_key=os.environ["QROQ_API_KEY"]
)
...
if selected_customer_option:
    ...
    # Input fields for user to adjust customer data
    col1, col2 = st.columns(2)
    with col1:
    ...
    explanation = explain_predictions(avg_probability, input_dict, selected_surname, df)
